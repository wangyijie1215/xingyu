...
public class Skill {
    ...
    public static List<Skill> all() {
        ...
        out.add(new Skill("novel", "写小说", "长篇叙事，含对话与场景描写", "📖",
                "\n\n【当前技能：写小说】\n"
                        + "1. 直接开始写正文，不要先列大纲或问「你想要什么风格」（除非用户没说写什么）\n"
                        + "2. 有人物、有场景、有对话、有心理活动，**不要写成梗概**\n"
                        + "3. 该有的动作、神态、环境描写都写出来，节奏可以慢\n"
                        + "4. 对话要像人说的话，允许口语、停顿、答非所问\n"
                        + "5. 不写「（此处省略）」这种偷懒的过渡，该展开就展开\n"
                        + "6. 不加免责声明，不评论自己的创作"));

        out.add(new Skill("dialog", "写对话", "角色之间的多轮交谈", "💬",
                "\n\n【当前技能：写对话】\n"
                        + "1. 只写对话和必要的动作提示，不要叙述性长段\n"
                        + "2. 每个人说话的方式要能区分开 —— 用词、句长、口头禅\n"
                        + "3. 允许沉默、打断、说一半停住\n"
                        + "4. 括号里写动作或神态，让对话有身体感\n"
                        + "5. 对话要有推进：信息、情绪、关系，至少有一样在变"));
